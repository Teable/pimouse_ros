...
class MotorTest(unittest.TestCase):
	...
	def test_put_freq(self):
		...
		for i in range(10):
			pub.publish(m)
			time.sleep(0.1)
		self.file_check("rtmotor_raw_l0",m.left,"wrong left value from motor_raw")
		self.file_check("rtmotor_raw_r0",m.right,"wrong right value from motor_raw")
...
if __name__ == '__main__':
	rospy.init_node('travis_test_motor')
